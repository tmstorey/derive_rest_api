...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create a reqwest blocking client wrapper
    ...
    let create_post_request = CreatePostBuilder::new()
        ...
        .body("This post was created using the derive_rest_api macro.".to_string())
        .user_id(1)
    ...
    let custom_client = ReqwestBlockingClient::with_client(custom_reqwest_client);
